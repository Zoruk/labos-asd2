...
${OBJECTDIR}/_ext/2060835112/GraphFromImage.o: ../Lab\ 2\ -\ Ex\ 2/GraphFromImage.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2060835112/GraphFromImage.o ../Lab\ 2\ -\ Ex\ 2/GraphFromImage.cpp

${OBJECTDIR}/_ext/2060835112/ex2.o: ../Lab\ 2\ -\ Ex\ 2/ex2.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2060835112
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2060835112/ex2.o ../Lab\ 2\ -\ Ex\ 2/ex2.cpp
